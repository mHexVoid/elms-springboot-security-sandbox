...
public class UserController {
	 ...
	 * <p>
	 * This endpoint retrieves the details of the authenticated user. The user is authenticated via Spring Security,
	 * and their information is fetched from the database using their email (from the {@link Authentication} object).
	 * Additionally, a new JWT token is generated and sent back in the response header.
	 * </p>
	 * <p><b>JWT Token Generation:</b> The token is created by the {@code JWTTokenGeneratorFilter} after authentication and
	 * is included in the response header for future requests.</p>
	 * 
	 * @param authentication The {@link Authentication} object containing the authenticated user’s details.
	 * 
	 * @return The authenticated user's details as an {@link EmployeeCredentials} object.
	 *         If the user cannot be found, returns {@code null}.
	 * 
