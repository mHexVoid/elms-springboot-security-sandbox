...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		 ...
		 * 
		 * - It is a collection of filters applied to incoming HTTP requests.
		 * - These filters enforce authentication and authorization based on configured rules.
		 * - Filters include authentication checks, CSRF protection, session management, etc.
		 * 
		 * - Applies authentication and authorization rules to all incoming HTTP requests.
		 * - Configured using `authorizeHttpRequests()`, `httpBasic()`, and `csrf()`.
		 * 
		 * ******************************************************************************************************
		 * 
		 * `authorizeHttpRequests()` - Configures access rules for different endpoints.
		 * 
		 * Lambda Expressions:
		 * Used here instead of method chaining for better readability and maintainability.
		 * Provides flexibility by enabling custom authorization rules.
		 */
		...
		http.authorizeHttpRequests(configurer -> configurer
				...
				/*
				 * Question: Is `/api/employees` an endpoint?
				...
				.requestMatchers(HttpMethod.DELETE, "/api/leaves/**").permitAll()
				/*
				 * Question: Is `/api/leaves` an endpoint?
