...
public class EmployeeLeaveRequestController {
    ...
    public ResponseEntity<Employees> updateEmployee(@RequestBody Employees updatedEmployee, @PathVariable Long id) {
    	//check how you going to work on update with jpa repository
        return new ResponseEntity<>(employeeService.save(updatedEmployee), HttpStatus.OK);
    }
    ...
    public ResponseEntity<LeaveRequests> updateLeaveRequestById(
    	...
    	//Look how you are going to work with update ?
        return ResponseEntity.status(HttpStatus.OK)
                             .body(leaveRequestService.save(updatedLeaveRequest));
    }
