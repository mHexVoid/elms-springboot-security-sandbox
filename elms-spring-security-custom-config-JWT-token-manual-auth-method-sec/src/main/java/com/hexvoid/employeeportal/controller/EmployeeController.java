...
@RequestMapping(value = "/api/noauth") // Defines the base URL for all endpoints in this controller
public class EmployeeController {
	...
	public Employees updateEmployeeById(@RequestBody Employees theEmptoUpdate, @PathVariable int id) {
		logger.info("Updating employee with ID: {} | New Details: {}", id, theEmptoUpdate);
		return theEmployeeServiceMethod.updateById(theEmptoUpdate, id);
	}
