 ...
 * It follows the DAO pattern and is marked as a Spring @Repository,
...
public class LeaveRequestDAOImpl implements LeaveRequestDao {
     ...
     * 
     * @param theEntityManager the JPA EntityManager instance provided by Spring.
     */
     ...
     * @return The merged (updated) LeaveRequests entity.
     */
    @Override
