...
public class EmployeeLeaveRequestController {
     ...
     *
     * Constructor injection is the preferred approach because:
     *   • It allows the fields to be declared as final (ensuring immutability).
     *   • It simplifies testing, as mocked dependencies can be easily injected.
     *   • @Autowired is not required if the class has only one constructor (Spring 4.3+).
     */
    @Autowired
